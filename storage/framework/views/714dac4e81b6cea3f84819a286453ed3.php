...
<?php $__env->startSection('title', 'Profil Desa Bulakwaru'); ?>
            ...
            <div class="row g-4 text-center">
                <div class="col-sm-6 col-lg-3">
                    <div class="p-3 border rounded bg-light h-100">
                        <img src="<?php echo e(asset('assets/img/struktur/lurah.jpg')); ?>" alt="Kepala Desa" class="img-fluid rounded-circle mb-2" style="width:110px; height:110px; object-fit:cover;">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="p-3 border rounded bg-light h-100">
                        <img src="<?php echo e(asset('assets/img/struktur/seketaris.jpg')); ?>" alt="Sekretaris Desa" class="img-fluid rounded-circle mb-2" style="width:110px; height:110px; object-fit:cover;">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="p-3 border rounded bg-light h-100">
                        <img src="<?php echo e(asset('assets/img/struktur/tata-usaha.jpg')); ?>" alt="Kaur Tata-Usaha dan Umum" class="img-fluid rounded-circle mb-2" style="width:110px; height:110px; object-fit:cover;">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="p-3 border rounded bg-light h-100">
                        <img src="<?php echo e(asset('assets/img/struktur/perencanaan.jpg')); ?>" alt="Kaur Perencanaan" class="img-fluid rounded-circle mb-2" style="width:110px; height:110px; object-fit:cover;">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project-Programmer\project-ta\resources\views/profil-desa.blade.php ENDPATH**/ ?>