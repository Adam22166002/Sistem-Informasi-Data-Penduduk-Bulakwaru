...
<script>
    ...
    formPenduduk.addEventListener("submit", async function(e) {
        ...
        const res = await fetch("<?php echo e(route('penduduk.store')); ?>", {
            method: "POST",
            headers: {
...
<?php /**PATH D:\Project-Programmer\project-ta\resources\views/admin/penduduk/modal_penduduk.blade.php ENDPATH**/ ?>