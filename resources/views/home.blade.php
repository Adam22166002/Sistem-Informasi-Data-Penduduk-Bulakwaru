                ...
                <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="6000">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('assets/img/backgrounds/hero-1.jpeg') }}" class="d-block w-100 hero-image" alt="Hero Image 1">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('assets/img/backgrounds/hero-2.jpg') }}" class="d-block w-100 hero-image" alt="Hero Image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('assets/img/backgrounds/hero-3.jpg') }}" class="d-block w-100 hero-image" alt="Hero Image 3">
                        </div>
                    </div>
        ...
        <div class="stat-card card border-0 shadow">
            <div class="card-body d-flex align-items-center p-4">
                ...
                <div class="ms-3">
                    ...
                    <h3 class="mb-0 fw-bold counter" data-target="{{ $jumlahPenduduk }}">0</h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="stat-card card border-0 shadow">
            <div class="card-body d-flex align-items-center p-4">
                ...
                <div class="ms-3">
                    ...
                    <h3 class="mb-0 fw-bold counter" data-target="{{ $jumlahKK }}">0</h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="stat-card card border-0 shadow">
            <div class="card-body d-flex align-items-center p-4">
                ...
                <div class="ms-3">
                    ...
                    <h3 class="mb-0 fw-bold counter" data-target="{{ $jumlahRumah }}">0</h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="stat-card card border-0 shadow">
            <div class="card-body d-flex align-items-center p-4">
                ...
                <div class="ms-3">
                    ...
                    <h3 class="mb-0 fw-bold counter" data-target="{{ $jumlahUser }}">0</h3>
                </div>
            </div>
        </div>
    </div>
