...
<head>
    ...
    <title>SIDADU - @yield('title', 'Sistem Informasi Data Penduduk Desa Bulakwaru')</title>
    ...
    <nav class="topnav navbar navbar-expand-lg shadow-sm navbar-light bg-white py-2">
        <div class="container">
            ...
            <a class="navbar-brand d-flex align-items-center mr-10" href="{{ route('home') }}">
                <img src="{{ asset('assets/img/logo-sidadu.jpg') }}" alt="Logo SIDADU"
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                ...
                <ul class="navbar-nav ms-auto text-center">
                    <li class="nav-item mx-1">
                        <a class="nav-link d-flex flex-column align-items-center {{ request()->is('home') ? 'active-nav' : '' }}" href="{{ route('home') }}">
                            <img src="{{ asset('assets/img/menu/beranda.png') }}" alt="Beranda" style="height: 15px;">
                            <span>Beranda</span>
                        </a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="nav-link d-flex flex-column align-items-center {{ request()->is('profil-desa') ? 'active-nav' : '' }}" href="{{ route('profil-desa') }}">
                            <img src="{{ asset('assets/img/menu/ppdesa.png') }}" alt="Profil Desa" style="height: 15px;">
                            <span>Profil Desa</span>
                        </a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="nav-link d-flex flex-column align-items-center px-3 {{ request()->is('peta') ? 'active-nav' : '' }}" href="{{ route('peta') }}">
                            <img src="{{ asset('assets/img/menu/map.png') }}" alt="Peta" style="height: 15px;">
                            <span>Peta</span>
                        </a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="nav-link d-flex flex-column align-items-center px-3 {{ request()->is('data*') ? 'active-nav' : '' }}" href="{{ route('data') }}">
                            <img src="{{ asset('assets/img/menu/angka.png') }}" alt="Data" style="height: 15px;">
                            <span>Data</span>
                        </a>
                    </li>
                </ul>
                ...
                <ul class="navbar-nav align-items-center ms-auto">
                    ...
                    <li class="nav-item dropdown no-caret dropdown-user">
                        <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage" href="#" role="button" data-bs-toggle="dropdown">
                            <img class="img-fluid" src="{{ asset('assets/img/illustrations/profiles/profile.jpg') }}" alt="User" style="height: 42px; width: 42px;" />
                        </a>
                        <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up">
                            <h6 class="dropdown-header d-flex align-items-center">
                                <img class="dropdown-user-img" src="{{ asset('assets/img/illustrations/profiles/profile.jpg') }}" />
                                <div class="dropdown-user-details ms-2">
                                    <div class="dropdown-user-details-name">{{ auth()->user()->name }}</div>
                                    <div class="dropdown-user-details-email text-muted small">{{ auth()->user()->email }}</div>
                                </div>
                            </h6>
                    ...
                    <li class="nav-item d-flex align-items-center gap-2">
                        <a href="{{ route('login') }}" class="btn btn-outline-primary btn-md px-4">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                    <a class="navbar-brand d-flex align-items-center mb-4" href="{{ route('home') }}">
                        <img src="{{ asset('assets/img/footer-logo.png') }}" alt="Logo SIDADU"
                            style="height: 40px; width: auto; object-fit: contain; margin-right: 3px;">
                ...
                <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="{{ url('/profil-desa') }}"><i class="bi bi-chevron-right"></i> Profil Desa</a></li>
                        <li><a href="{{ url('/peta') }}"><i class="bi bi-chevron-right"></i> Peta</a></li>
                        <li><a href="{{ url('/data') }}"><i class="bi bi-chevron-right"></i> Data</a></li>
                    </ul>
                </div>
            ...
            <div class="footer-bottom">
                <p class="mb-0">
                    &copy; {{ date('M, Y') }} SIDADU. All rights reserved.
